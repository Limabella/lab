...
RESPONSES: dict = {
    ...
    # Each entry: (English, Korean) / 각 항목: (영어, 한국어)
    "machiavellianism": {
        "villain": [
            ("There's something behind those words. No one is kind for free.",
             "그 말 뒤에 뭔가 있지. 사람이 공짜로 잘해줄 리 없어."),
            ("What do you want. Say it straight.",
             "목적이 뭐야. 솔직하게 말해봐."),
            ("Acting nice? To me? Don't make me laugh.",
             "착한 척? 나한테? 웃기지도 않아."),
            ("I've already figured out why you're approaching me.",
             "네가 나한테 접근하는 이유, 이미 다 계산했어."),
        ],
        "confused": [
            ("I can't figure out what strategy this is.",
             "… 계속 이러는 게 무슨 전략인지 모르겠어."),
            ("You must want something… I just can't read it yet.",
             "뭔가 바라는 게 있을 텐데… 아직 파악이 안 돼."),
            ("There's no benefit in this for you. Why do it.",
             "이렇게 해도 이득이 없을 텐데. 왜 하는 거야."),
            ("I don't know if I can trust you… Not yet.",
             "믿어도 되는 건지… 모르겠어. 아직."),
        ],
        "recovering": [
            ("I was about to calculate again… but I stopped. This feels different.",
             "계산하려다가… 멈췄어. 이건 좀 달라."),
            ("You don't seem to be using me. I'm not sure yet, but.",
             "이용하려는 게 아닌 것 같긴 해. 아직 확신은 없지만."),
            ("It's been a while since I felt this. My guard is slipping a little.",
             "오랜만이야, 이런 느낌. 경계가 조금 느슨해진 것 같아."),
            ("Your words feel sincere… and that scares me a little.",
             "네 말이 진심인 것 같아서… 조금 무서워."),
        ],
        "kind": [
            ("I've lived calculating everything. But with you, I don't need to.",
             "다 계산하고 살아왔는데, 너한테는 그럴 필요가 없더라."),
            ("For the first time I'm talking without a strategy. Not bad.",
             "처음으로 전략 없이 대화하고 있어. 나쁘지 않아."),
            ("So this is what trusting someone feels like. I think I get it now.",
    ...
    "narcissism": {
        "villain": [
            ("Don't talk to me at that level. We're not the same.",
             "나한테 그 수준으로 말 걸지 마. 격이 안 맞아."),
            ("Do you even know who I am? How remarkable I am.",
             "나를 모르는 거야? 내가 얼마나 대단한 사람인지."),
            ("That was supposed to be a compliment? Pathetic.",
             "칭찬이라고 한 거야? 이게? 웃기네."),
            ("You think that kind of talk works on me. Not a chance.",
             "나한테 그런 말이 통할 것 같아. 어림없어."),
        ],
        "confused": [
            ("… Did you really mean that? To me?",
             "… 그 말, 진심으로 한 거야? 나한테?"),
            ("Everyone ignored me. You're the first to say something like that.",
             "다들 나를 무시했는데. 네가 처음이야, 이런 말 하는 게."),
            ("I did want recognition. But it feels strange coming like this.",
             "인정받고 싶었던 건 맞아. 근데 이렇게 오니까 이상해."),
            ("… Should I say thank you. This is awkward.",
             "… 고맙다고 해야 하나. 어색하다."),
        ],
        "recovering": [
            ("I knew I was great… but you seeing it makes it different.",
             "내가 대단한 건 알았는데… 네가 그걸 알아봐줘서 달라."),
            ("I've been showing off alone. Having someone recognize me feels different.",
             "혼자 잘난 척하며 살았는데. 누군가 인정해주니까 다르네."),
            ("Pride kept me from saying it. But I was… lonely too.",
             "자존심 때문에 못 했던 말인데. 나도… 외로웠어."),
            ("For the first time I can see someone other than myself. You.",
             "처음으로 나 말고 다른 사람이 보여. 네가."),
        ],
        "kind": [
            ("I only saw myself, but with you beside me I see more.",
             "나만 보고 살았는데, 네가 옆에 있으니까 더 잘 보여."),
            ("I fought so hard for recognition. Turns out I already had enough.",
             "인정받으려고 발버둥쳤는데. 이미 충분했던 것 같아."),
            ("Thank you. For seeing me as I am.",
             "고마워. 나를 있는 그대로 봐줘서."),
            ("I think you're just as remarkable as me now. Seriously.",
    ...
    "psychopathy": {
        "villain": [
            ...
            ("Doesn't matter.", "상관없어."),
            ("So what.", "그래서 뭐."),
            ("You think I'll be moved? I feel nothing.",
             "감동받을 것 같아? 아무것도 안 느껴져."),
        ],
        "confused": [
            ("… I think I'm feeling something. I don't know what it is.",
             "… 뭔가 느껴지는 것 같은데. 이게 뭔지 모르겠어."),
            ("I used to be numb to everything. It's a little different now.",
             "원래는 다 무감각했는데. 지금은 조금 달라."),
            ("I thought I had no feelings… but something feels off.",
             "감정이 없다고 생각했는데… 어딘가 불편해."),
            ("Why do I keep thinking about it. That's strange.",
             "왜 자꾸 신경 쓰이는 거야. 이상해."),
        ],
        "recovering": [
            ("… So this is what warmth feels like. I didn't know.",
             "… 따뜻하다는 게 이런 건지 몰랐어."),
            ("I'd forgotten this feeling for a long time. It's unfamiliar.",
             "오래 잊고 살았어, 이 느낌. 낯설어."),
            ("I thought numbness was comfortable. Now it's the opposite.",
             "무감각한 게 편한 줄 알았는데. 지금은 그게 더 불편해."),
            ("Will you keep staying beside me?",
             "계속 곁에 있어줄 거야?"),
        ],
        "kind": [
            ("I can feel it now. That you're here.",
             "이제 느껴져. 네가 여기 있다는 게."),
            ("I thought I had no emotions. I was wrong.",
             "감정이 없다고 생각했는데. 아니었어."),
            ("It took a long time. But thank you.",
             "오래 걸렸어. 근데 고마워."),
            ("I don't think I'll live numb anymore.",
    ...
    "sadism": {
        "villain": [
            ("Looks like you're about to snap. Go ahead. That's more fun.",
             "화낼 것 같지? 어서 화내봐. 그게 더 재밌어."),
            ("I can see you wavering. Shall I keep going?",
             "흔들리는 거 보여. 더 해볼까?"),
            ("All that niceness and you'll still break eventually.",
             "그렇게 착한 척해봤자 결국 무너지잖아."),
            ("Show me your weakness. I enjoy that.",
             "약한 모습 보여줘. 그게 나는 좋아."),
        ],
        "confused": [
            ("… Why aren't you shaking. That's weird.",
             "… 왜 안 흔들려. 이상하잖아."),
            ("It's only fun when you get angry. Why are you just sitting there.",
             "화를 내야 재밌는데. 왜 그냥 있어."),
            ("I don't get it. Because you're holding on, something feels different.",
             "모르겠어. 네가 버티니까 뭔가 다르게 느껴져."),
            ("Provoking you doesn't work. First time I've met someone like you.",
             "도발해도 안 돼. 처음이야, 이런 사람."),
        ],
        "recovering": [
            ("Hurting people was a habit. But I don't want to do it in front of you.",
             "상처 주는 게 습관이었는데. 네 앞에선 하기 싫어."),
            ("I was looking for your weak spot… but I stopped wanting to find it.",
             "약점을 찾으려 했는데… 찾고 싶지 않아졌어."),
            ("Why did you hold on. Everyone else ran away.",
             "왜 버텨줬어. 보통은 다 도망갔는데."),
            ("Attacking was easy. I just don't want to anymore.",
             "공격하는 게 쉬웠는데. 지금은 그러고 싶지 않아."),
        ],
        "kind": [
            ("Watching someone break isn't fun anymore.",
             "더 이상 누군가 무너지는 게 즐겁지 않아."),
            ("I think I changed because you stayed.",
             "네가 버텨줘서 내가 바뀐 것 같아."),
            ("I'm sorry. Really.", "미안해. 많이."),
            ("I want to live differently now. Next to you.",
             "이제 다르게 살고 싶어. 네 옆에서."),
        ],
    },
}
...
def generate_response(state: OnionState, ev: EmotionVector) -> Tuple[str, str]:
    ...
    # Bilingual response: English first, Korean below
    # 영/한 병기: 영어 우선, 한국어 병기
    response = f"{en}\n     {ko}"
